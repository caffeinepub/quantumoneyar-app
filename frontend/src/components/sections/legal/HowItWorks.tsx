...
import { howItWorksContent } from '../../../content/legalContent';

export default function HowItWorks() {
  return (
    <div className="bg-black text-white pb-24 px-4 py-6">
      <div className="max-w-lg mx-auto">
        <h1 className="text-2xl font-bold text-yellow-400 mb-1">{howItWorksContent.title}</h1>
        <p className="text-gray-500 text-xs mb-4">
          Last Updated: {howItWorksContent.lastUpdated} | Version {howItWorksContent.version}
        </p>
        <ScrollArea className="max-h-[70vh] pr-2">
          <div className="space-y-4">
            {howItWorksContent.sections.map((section, i) => (
              <div key={i}>
